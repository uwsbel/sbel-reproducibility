...
python3 main_fnode.py     --test_case Slider_Crank     --seed 42     --data_total_steps 4500     --train_ratio $(python3 -c "print(1/3)")    --epochs 450     --lr 0.0005     --lr_scheduler  exponential     --lr_decay_rate 0.99    --optimizer  adam  
...
python3 main_fnode.py     --test_case Slider_Crank     --seed 42     --data_total_steps 4500     --train_ratio $(python3 -c "print(1/3)")    --epochs 450     --lr 0.0004     --lr_scheduler  exponential     --lr_decay_rate 0.99    --optimizer  adam
