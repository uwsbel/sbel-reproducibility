...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < numPart; i++) {
        ...
        myFsiSystem.GetDataManager()->AddSphMarker(
            ...
            fsi::mR3(0.0),                               // tauxxyyzz
            fsi::mR3(0.0));                              // tauxyxzyz
    }
...
void CreateSolidPhase(ChSystemSMC& mphysicalSystem,
    ...
    /// Create falling cone
    ChVector<> cone_pos = ChVector<>(paramsH->bodyIniPosX, 
                                     paramsH->bodyIniPosY, 
                                     fzDim + 0.5 * cone_length + 0.5 * initSpace0);
    ...
    utils::AddConeGeometry(cone.get(), mysurfmaterial, cone_radius, cone_length, ChVector<>(0.0, 0.0, 0.0), ChQuaternion<>(1, 0, 0, 0));
