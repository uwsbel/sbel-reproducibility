...
makeSubplot(t, EfArrays,'','$$\mathbf{E}_f$$ (N)','', LineWidth, FontSize);
hdl = gca;
set(gca, 'XTick', [])
xlim(timeRange)
...
makeSubplot(t,TeArrays,'','$$\mathcal{T}_e$$ (Nm)','', LineWidth, FontSize);
hdl = gca;
set(gca, 'XTick', [])
xlim(timeRange)
...
hold on
grid on
makeSubplot(t,DfArrays,'time (sec)','$$\mathbf{D}_f$$ (N)', '', LineWidth, FontSize);
xlim(timeRange)

subplot(2,3,5);
hold on
grid on
makeSubplot(t,TdArrays,'time (sec)','$$\mathcal{T}_d$$ (Nm)', '', LineWidth, FontSize);
xlim(timeRange)
