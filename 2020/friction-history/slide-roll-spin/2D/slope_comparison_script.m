...
%	slope_theta = min(slope_theta + 0.001, 0.25);
    slide_slack_s = mu_s*m*g*cos(slope_theta)/Ke;
    slide_slack_k = mu_k*m*g*cos(slope_theta)/Ke;
...
subplot(2,3,1)
hold on
plot(t, x, 'r','LineWidth', LineWidth);
xlabel('time (sec)', 'FontSize', FontSize);
ylabel('position (m)', 'FontSize', FontSize);
set(gca, 'linewidth', LineWidth);
a = get(gca, 'XTick');
...
subplot(2,3,4)
hold on
plot(t, v,'r', 'LineWidth', LineWidth);
xlabel('time (m/s)', 'FontSize', FontSize);
ylabel('velocity (m/s)', 'FontSize', FontSize);
set(gca, 'linewidth', LineWidth);
a = get(gca, 'XTick');
...
subplot(2,3,2)
hold on
plot(t, Ef_array,'r', 'LineWidth', LineWidth)
xlabel('time (sec)', 'FontSize', FontSize);
ylabel('F_r elastic part (N)', 'FontSize', FontSize);
set(gca, 'linewidth', LineWidth);
a = get(gca, 'XTick');
...
subplot(2,3,5)
hold on
plot(t, Df_array,'r', 'LineWidth', LineWidth)
%title(sprintf('Ke=%.0gN/m, Kd=%.2fNs/m, dt = %gsec', Ke, Kd,dt));
xlabel('time (sec)', 'FontSize', FontSize);
ylabel('F_r damping part (N)', 'FontSize', FontSize);
set(gca, 'linewidth', LineWidth);
...
subplot(2,3,3)
hold on
plot(t, Sij_array,'r', 'LineWidth', LineWidth)
xlabel('time (sec)', 'FontSize', FontSize);
ylabel('S_{ij}', 'FontSize', FontSize);
set(gca, 'linewidth', LineWidth);
a = get(gca, 'XTick');
...
subplot(2,3,6)
hold on
plot(t, dSij_array,'r', 'LineWidth', LineWidth)
%title(sprintf('Ke=%.0gN/m, Kd=%.2fNs/m, dt = %gsec', Ke, Kd,dt));
xlabel('time (sec)', 'FontSize', FontSize);
ylabel('\Delta S_{ij}', 'FontSize', FontSize);
set(gca, 'linewidth', LineWidth);
