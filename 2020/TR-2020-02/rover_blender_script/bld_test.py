...
for k in range(401,501,1):
    bpy.ops.wm.read_factory_settings(use_empty=True)

    scene = bpy.context.scene
    scene.objects.keys()

    root_dir = "/srv/home/whu59/research/rendering/17/rover_blender_script/"
