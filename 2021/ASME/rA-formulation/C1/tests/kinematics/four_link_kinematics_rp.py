...
sys = rpSimEngine3D("../models/four_link.mdl")
...
# ax2.set_title('Link 3 acc, y')
#
# _, ax3 = plt.subplots()
# ax3.plot(sys.t_grid, link3[:, 2])
# ax3.set_title('Link 3 acc, z')
#
# _, ax4 = plt.subplots()
...
# ax7.set_title('Link 1 acc, x')
#
# _, ax8 = plt.subplots()
# ax8.plot(sys.t_grid, link1[:, 1])
# ax8.set_title('Link 1 acc, y')
#
# _, ax9 = plt.subplots()
# ax9.plot(sys.t_grid, link1[:, 2])
# ax9.set_title('Link 1 acc, z')

# velocities
# _, ax1 = plt.subplots()
# ax1.plot(sys.t_grid, link3v[:, 0])
# ax1.set_title('Link 3 vel, x')
#
# _, ax2 = plt.subplots()
