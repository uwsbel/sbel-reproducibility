...
def run_model(args):
    ...
    pos_exact, vel_exact, acc_exact, _, _ = model_fn(['--form', form, '--mode', 'kinematics', '--tol', '1e-12', '--step_size', '1e-4'])
    #pos_exact, vel_exact, acc_exact, _ = model_fn(['--form', form, '--mode', 'dynamics', '--tol', '1e-1', '--step_size', '5e-6'])
    #pos_exact, vel_exact, acc_exact, _ = model_fn(['--form', form, '--mode', 'dynamics', '--tol', '1e-3', '--step_size', '1e-4'])
