...
total_frame = 150
first_frame = 451
num_cpu_core = 25 #multiprocessing.cpu_count()
...
def process(core_idx,num_cpu_core,total_frame):
    ...
    for k in range(start_frame, end_frame, 1):
        ...
        file_in = home_root + "chrono_fsi_granular_1001/chrono-dev-io-test-random-motion/curiosity-523-fewSPH-C-Wi=0.8/DEMO_OUTPUT/FSI_Curiosity/Curiosity/"
