...
start_frame = jobid*1 + 379
end_frame = jobid*1 + 380
...
for k in range(start_frame,end_frame,1):
    ...
    root_dir = "/srv/home/whu59/research/sbel/d_chrono_fsi_granular/chrono_fsi_granular_1001/chrono-dev-io-test-random-motion/curiosity-204-C-Wi=0.8/Animation_Blender/"

    file_fluid = root_dir + "granular_file_new/"
    ...
    bpy.ops.object.camera_add(enter_editmode=False, align='WORLD', location=(8.899*1.1, -11.285*1.1, 4.2723*1.32),
                              rotation=(1.2548917, -0.0139800873, 0.6300638), scale=(5.0, 5.0, 5.0))
    ...
    bpy.context.scene.render.filepath = root_dir + "image_file_new/"+str(k)+".png"
