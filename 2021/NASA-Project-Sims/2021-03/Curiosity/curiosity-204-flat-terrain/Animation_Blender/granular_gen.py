...
def process(core_idx,num_cpu_core,total_frame):
    ...
    for k in range(start_frame, end_frame, 1):
        ...
        file_in = home_root + "chrono_fsi_granular_1001/chrono-dev-io-test-random-motion/curiosity-204-C-Wi=0.8/DEMO_OUTPUT/FSI_Curiosity/Curiosity/"
        file_out = "granular_file_new/"
