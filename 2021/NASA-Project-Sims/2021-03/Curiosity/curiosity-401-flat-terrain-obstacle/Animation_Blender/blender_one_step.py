...
dis = []
rot = []
home_root = "/srv/home/whu59/research/sbel/d_chrono_fsi_granular/chrono_fsi_granular_1001/chrono-dev-io-Curiosity/31/"
data_in = home_root + "DEMO_OUTPUT/FSI_Curiosity/Curiosity/"
file_in = home_root + "Animation_Blender/"
mesh_in = home_root + "Mesh_BCE/"
for i in range(15):
...
start_frame = jobid*10 + 1
end_frame = jobid*10 + 2
for i in range(start_frame, end_frame, 1):
    ...
    file_loc_1 = mesh_in + 'wheelSimplified.obj'
    ...
    file_loc_2 = mesh_in + 'wheelSimplified.obj'
    ...
    file_loc_3 = mesh_in + 'wheelSimplified.obj'
    ...
    file_loc_4 = mesh_in + 'wheelSimplified.obj'
    ...
    file_loc_5 = mesh_in + 'wheelSimplified.obj'
    ...
    file_loc_6 = mesh_in + 'wheelSimplified.obj'
    ...
    file_loc_11 = mesh_in + 'ster_front.obj'
    ...
    file_loc_12 = mesh_in + 'ster_front.obj'
    ...
    file_loc_13 = mesh_in + 'ster_back.obj'
    ...
    file_loc_14 = mesh_in + 'ster_back.obj'
    ...
    dis_terrain = []
    with open(data_in + "fluid" + str (i) + ".csv", 'r') as file_terrain:
        dis_terr_temp = []
        reader = csv.reader(file_terrain)
        j = 0
        for row in reader:
            j=j+1
            if j>1 and j<100:
                dis_terr_buff = []
                dis_terr_buff.append(float(row[0]))
                dis_terr_buff.append(float(row[1]))
                dis_terr_buff.append(float(row[2]))
                dis_terr_temp.append(dis_terr_buff)
                file_loc_nn = file_in + 'pyramid.obj'
                imported_object_14 = bpy.ops.import_scene.obj(filepath=file_loc_nn)
                obj_object_14 = bpy.context.object
                bpy.data.objects["pyramid"].location.x += float(row[0])
                bpy.data.objects["pyramid"].location.y += float(row[1])
                bpy.data.objects["pyramid"].location.z += float(row[2])
                bpy.data.objects["pyramid"].rotation_mode = 'QUATERNION'
                q_nn = (1,0,0,0)
                bpy.data.objects["pyramid"].rotation_quaternion = q_nn
        dis_terrain.append(dis_terr_temp)
    ...
    bpy.ops.object.camera_add(enter_editmode=False, align='WORLD', location=(8.199*1.2, -11.285*1.2, 4.6723*1.44),
