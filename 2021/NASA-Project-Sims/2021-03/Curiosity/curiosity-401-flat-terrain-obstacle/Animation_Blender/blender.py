...
for k in range(start_frame,end_frame,1):
    ...
    root_dir = "/srv/home/whu59/research/sbel/d_chrono_fsi_granular/chrono_fsi_granular_1001/chrono-dev-io-test-random-motion/curiosity-401-C-Wi=0.8/Animation_Blender/"
