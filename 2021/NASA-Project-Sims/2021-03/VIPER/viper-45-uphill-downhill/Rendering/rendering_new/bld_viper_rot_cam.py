...
home_root = "/srv/home/whu59/research/sbel/d_chrono_fsi_granular/chrono_fsi_granular_1001/chrono-dev-io-Viper/42/"
# index number:
# 0 - body
# 1 - L sus 1
# 2 - L sus 2
...
start_frame = jobid*20 + 1
end_frame = jobid*20 + 21
for i in range(start_frame, end_frame, 1):
    ...
    bpy.ops.object.camera_add(enter_editmode=False, align='WORLD', scale=(1.0, 1.0, 1.0))
    ...
    point_at(cam, bpy.data.objects["body"].location, roll=math.radians(0))
    ...
    bpy.context.scene.render.filepath = home_root + "Rendering/image_file/moving_camera/"+str(i)+".png"
