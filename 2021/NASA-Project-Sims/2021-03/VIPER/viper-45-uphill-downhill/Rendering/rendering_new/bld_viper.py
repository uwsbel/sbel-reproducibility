...
dis = []
rot = []
home_root = "/srv/home/whu59/research/sbel/d_chrono_fsi_granular/chrono_fsi_granular_1001/chrono-dev-io-test-random-motion/viper-45-fewSPH-C-Wi=0.8/"
...
for i in range(start_frame, end_frame, 1):
    ...
    bpy.ops.object.camera_add(enter_editmode=False, align='WORLD', location=(8.199*0.8, -11.285*0.8, 4.4723*0.96),
                              rotation=(1.2548917, -0.0139800873, 0.6300638), scale=(5.0, 5.0, 5.0))
