...
std::string obj_path = "./wheel_grouser.obj";
std::string BCE_path = "./BCE_wheel_grouser.txt";
...
void WritewheelVTK(ChSystemSMC& mphysicalSystem, 
    ...
    // std::string obj_path = "./wheel_3mm_grouser.obj";
    ...
    if(1==0){// save to obj file
        sprintf(filename, "%s/wheel_grouser_%d.obj", paramsH->demo_dir, this_frame);
    ...
    if(1==1){// save to vtk file
        sprintf(filename, "%s/wheel_grouser_%d.vtk", paramsH->demo_dir, this_frame);
        std::ofstream file;
        file.open(filename);
...
void CreateSolidPhase(ChSystemSMC& mphysicalSystem,
    ...
    myFsiSystem.AddFsiBody(wheel);
    // std::string BCE_path = "./BCE_wheel_3mm_grouser_d3mm.txt";
