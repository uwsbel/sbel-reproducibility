...
def model(theta,fileName,endTime):
    ...
    veh1_param._steerMap[2]._y = -theta[0]
    veh1_param._steerMap[-3]._y = theta[0]
...
def main():
    ...
    with pm.Model() as model:
        # steering map points
        f_06 = pm.Uniform("f_06",lower=0.165806,upper=0.2321288,initval = 0.2199116) # Between 9.5 and 13.3 degs
...
if __name__ == "__main__":
    ...
    # Get the input file 
    fileName1 = "./inputs" + ART_path + "06s-rampt-10s/" + file1 + ".txt"
    ...
    # open the data files
    with open("./data/" + ART_path +  "06s-rampt-10s" + data_type + file1 + ".npy", 'rb') as f:
    ...
    data_ART1 = pd.read_csv( "./data" + ART_path +  "06s-rampt-10s"  + "/" + file1 +  ".csv", sep = ",", header = "infer")
