...
def model(theta,fileName,endTime):
    ...
    veh1_param._steerMap[-4]._y = theta[0]
...
def main():
    ...
    with pm.Model() as model:
        # steering map points
        f_04 = pm.Uniform("f_04",lower=0.0785398,upper=0.164061,initval = 0.151844) # Between 4.5  and 9.4 degs
...
if __name__ == "__main__":
    ...
    # Get the input file 
    fileName1 = "./inputs" + ART_path + "04s-rampt-10s/" + file1 + ".txt"
    ...
    # open the data files
    with open("./data/" + ART_path +  "04s-rampt-10s" + data_type + file1 + ".npy", 'rb') as f:
    ...
    data_ART1 = pd.read_csv( "./data" + ART_path +  "04s-rampt-10s"  + "/" + file1 +  ".csv", sep = ",", header = "infer")
