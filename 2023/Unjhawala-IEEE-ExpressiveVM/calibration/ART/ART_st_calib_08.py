...
def main():
    ...
    with pm.Model() as model:
        # steering map points
        f_08 = pm.Uniform("f_08",lower=0.2356194,upper=0.3368485,initval = 0.301942) # Between 13.5 and 19.3 degs
...
if __name__ == "__main__":
    ...
    # Get the input file 
    fileName1 = "./inputs" + ART_path + "08s-rampt-10s/" + file1 + ".txt"
    ...
    # open the data files
    with open("./data/" + ART_path +  "08s-rampt-10s" + data_type + file1 + ".npy", 'rb') as f:
    ...
    data_ART1 = pd.read_csv( "./data" + ART_path +  "08s-rampt-10s"  + "/" + file1 +  ".csv", sep = ",", header = "infer")
