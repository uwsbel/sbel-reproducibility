...
def model(theta,fileName,endTime):
    ...
    veh1_param._steerMap[-5]._y = theta[0]
...
def main():
    ...
    with pm.Model() as model:
        # steering map points
        f_02 = pm.Uniform("f_02",lower=0,upper=0.0663225,initval = 0.0314159) # Between 0 and 3.8 degs
...
if __name__ == "__main__":
    ...
    # Get the input file 
    fileName1 = "./inputs" + ART_path + "02s-rampt-10s/" + file1 + ".txt"
    ...
    # open the data files
    with open("./data/" + ART_path +  "02s-rampt-10s" + data_type + file1 + ".npy", 'rb') as f:
    ...
    data_ART1 = pd.read_csv( "./data" + ART_path +  "02s-rampt-10s"  + "/" + file1 +  ".csv", sep = ",", header = "infer")
