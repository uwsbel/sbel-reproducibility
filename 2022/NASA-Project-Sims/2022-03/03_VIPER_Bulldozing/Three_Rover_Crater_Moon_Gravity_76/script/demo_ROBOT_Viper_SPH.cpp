...
int main(int argc, char* argv[]) {
    ...
    for (int tStep = 0; tStep < stepEnd + 1; tStep++) {
        ...
        if(time < 3){
            driver1 = chrono_types::make_shared<ViperSpeedDriver>(0.1, 0);
            driver2 = chrono_types::make_shared<ViperSpeedDriver>(0.1, 0);
            driver3 = chrono_types::make_shared<ViperSpeedDriver>(0.1, 0);
        }
...
void CreateSolidPhase(ChSystemNSC& mphysicalSystem, 
    ...
    rover_one->Initialize(ChFrame<>(ChVector<>(paramsH->bodyIniPosX, paramsH->bodyIniPosY, paramsH->bodyIniPosZ), QUNIT));
    rover_two->SetDriver(driver2);
