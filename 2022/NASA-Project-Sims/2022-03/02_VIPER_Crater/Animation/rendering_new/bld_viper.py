...
home_root = "/srv/home/whu59/research/sbel/d_chrono_fsi_granular/chrono_fsi_granular_1009/viper_sim/"
data_in = home_root + "DEMO_OUTPUT/FSI_VIPER/Rover_rock_34/"
file_in = home_root + "Animation_Blender/rendering_new/chrono_viper_data/render/"
image_in = home_root + "Animation_Blender/Image/34/new/"
...
for i in range(start_frame, end_frame, 1):
    ...
    cam.location = rot_pos((0, 0, 6), 15, cur_rad)
    point_at(cam, (0, 0, 1), roll=math.radians(0))
