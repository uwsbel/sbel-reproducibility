...
data_in = home_root + "DEMO_OUTPUT/FSI_M113/M113_05/"
file_in = home_root + "Animation_Blender/rendering_new/chrono_m113_data/M113_render/"
image_in = home_root + "Animation_Blender/Image/M113_05/with_chassis_rot_texture_two_lights_new/"
...
for i in range(start_frame, end_frame, 1):
    ...
    light_object.location = ( 14 * math.cos(angle_pi) + dis[0][i][0] - 2.0, 14 * math.sin(angle_pi) + dis[0][i][1], 15)
    ...
    # change location
    light_object1.location = ( dis[0][i][0] - 2.0,  dis[0][i][1] - 0.0, 15)
