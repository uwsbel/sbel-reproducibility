...
void ChSystemFsi::SetFriction(double mu) {
    m_paramsH->mu_fric_s = mu;
    m_paramsH->mu_fric_2 = mu;
}
...
void ChSystemFsi::AddWheelBCE_Grouser(std::shared_ptr<ChBody> body,
                                 ...
                                 bool cartesian) {
    thrust::host_vector<Real4> posRadBCE;
    utils::CreateBCE_On_Wheel_Grouser(posRadBCE, radius, wide, grouser_height, grouser_wide, 
