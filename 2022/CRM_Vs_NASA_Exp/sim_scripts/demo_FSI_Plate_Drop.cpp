...
const std::string out_dir = GetChronoOutputPath() + "FSI_DamBreak_5s_dt1e_6_mu05_alpha00_100kg_moreFrames";
...
void CreateSolidPhase(ChSystemSMC& sysMBS, ChSystemFsi& sysFSI) {
    ...
    // sysFSI.AddBoxBCE(ground, pos_xn + ChVector<>(bxDim / 4 + 4 * iniSpacing, 0.0, 10 * iniSpacing), QUNIT, size_YZ, 23);
