...
double Viper::GetRoverMass() const {
    ...
    std::cout << "  m_chassis: " << m_chassis->GetBody()->GetMass() << std::endl;
    std::cout << "  m_wheels: " << m_wheels[0]->GetBody()->GetMass() << std::endl;
    std::cout << "  m_upper_arms: " << m_upper_arms[0]->GetBody()->GetMass() << std::endl;
    std::cout << "  m_lower_arms: " << m_lower_arms[0]->GetBody()->GetMass() << std::endl;
    std::cout << "  m_uprights: " << m_uprights[0]->GetBody()->GetMass() << std::endl;
    return tot_mass;
}
