...
from chrono_code.models.clarification import (
    ClarificationOption,
...
_user_spec_var: "ContextVar[Optional[Any]]" = ContextVar(
    "chrono_code_user_spec", default=None
)
...
class ScenePredicate(BaseModel):
    ...
    chrono_code/skills/planning/scene_coordinate_system/SKILL.md).
    ...
    predicate: str = Field(
        ...
        description=(
            ...
            "chrono_code/skills/planning/scene_coordinate_system. "
...
class CameraPose(BaseModel):
    ...
    :func:`chrono_code.utils.setup_preview_camera` so the VLM review gets
...
class GeometryRelation(BaseModel):
    ...
    relation_name: str = Field(
        description=(
            ...
            "chrono_code/skills/geometry/scene_relations/SKILL.md "
...
class ObjectTopology(BaseModel):
    ...
    relation: Optional[str] = Field(
        default=None,
        description=(
            "Relation pattern from chrono_code/skills/planning/"
...
class SimulationPlan(BaseModel):
    ...
    recording_mode: Literal["vsg_only", "sensor_cams"] = Field(
        ...
        description=(
            ...
            "'vsg_only': VSG window with chrono_code.utils.vsg_recording "
    ...
    camera: Optional[CameraConfig] = Field(
        ...
        description="Sensor camera configuration for video generation for review. "
            ...
            "chrono_code.utils.setup_preview_camera(...) for every view to produce MP4 video.",
    )
    ...
    def coerce_all_fields(cls, v: Any) -> Any:
        ...
        if md and not v.get("objectives") and not v.get("implementation_steps"):
            from chrono_code.models.plan_parser import (
