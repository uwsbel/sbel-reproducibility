"""
Runtime registry for Agent Skills in Chrono-Code.
"""
...
from chrono_code.models.handoff import SkillBundle
from chrono_code.skills.base import ChronoSkill, SkillIssue
from chrono_code.skills.loader import parse_skill_md
    ...
    def discover(cls, skills_dir: Path) -> None:
        ...
        def _load_one(skill_dir: Path) -> None:
            try:
                ...
                if skill_py.exists():
                    module_path = "chrono_code.skills." + ".".join(rel_parts) + ".skill"
