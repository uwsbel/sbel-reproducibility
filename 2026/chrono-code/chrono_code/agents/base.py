"""
Base agent class for all Chrono-Code agents.
...
from chrono_code.utils.logger import AgentLogger
from chrono_code.utils.dialog_manager import DialogManager
from chrono_code.workflow.events import (
        ...
        if provider == "anthropic":
            ...
            if final_base and "openrouter.ai" in str(final_base).lower():
                oai_kwargs["default_headers"] = {
                    "HTTP-Referer": "https://github.com/projectchrono/chrono-code",
                    "X-Title": "Chrono-Code",
                }
