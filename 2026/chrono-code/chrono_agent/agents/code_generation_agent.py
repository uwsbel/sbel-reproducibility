...
from chrono_agent.utils.response_parser import ResponseParser
from chrono_agent.models.error_context import ErrorSignature
from chrono_agent.models.handoff import FailureContext, HistoryContext, LLMHandoff, SkillBundle, StructuredError, PriorError
from chrono_agent.skills import SkillRegistry
from chrono_agent.tools import make_code_agent_tools
from chrono_agent.utils.error_utils import (
    classify_error,
    compact_tool_output,
    elide_middle,
...
from chrono_agent.utils.diff_utils import (
    compute_unified_diff,
    parse_hunks,
)
from chrono_agent.utils._signature_digest import build_reference_block as build_utils_reference_block
from chrono_agent.validators import (
...
class CodeGenerationAgent(BaseAgent):
    ...
    def _check_utils_calls(self, generated_code: Optional[GeneratedCode]) -> str:
        """Static AST check for misuse of chrono_agent.utils.* APIs.
    ...
    async def _run_tool_loop(
        ...
        try:
            from chrono_agent.tools.code_agent_tools import _iteration_dir as _iter_dir
    ...
    async def _execute_with_tools(
        ...
        from chrono_agent.agents.execution_agent import prepare_next_iteration_dir
        from chrono_agent.tools.code_agent_tools import set_iteration_dir
    ...
    async def _route_skills_via_llm(
        ...
        try:
            from chrono_agent.agents.skill_router_agent import (
                SkillRouterAgent,
                build_plan_summary,
            )
        except Exception as exc:
