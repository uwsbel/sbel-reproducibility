...
from chrono_agent.tools.signature_injector import format_reference_block
...
def _load_validate_chrono_apis_module():
    ...
    try:
        spec = importlib.util.spec_from_file_location(
            "_chrono_agent_validate_chrono_apis_inproc",
...
def _resolve_validator_python() -> str:
    ...
    candidates.append(Path.home() / "miniconda3" / "envs" / "chrono-agent" / "bin" / "python")
...
def make_code_agent_tools(
    ...
    async def query_skill(skill_name: str, question: str) -> str:
        ...
        :class:`chrono_agent.agents.skill_query_agent.SkillQueryAgent`.
        ...
        if subagent is None:
            ...
            # SDK installed).
            from chrono_agent.agents.skill_query_agent import SkillQueryAgent
    ...
    # shares one session.
    from chrono_agent.tools.claude_code_tools import make_claude_code_tools
