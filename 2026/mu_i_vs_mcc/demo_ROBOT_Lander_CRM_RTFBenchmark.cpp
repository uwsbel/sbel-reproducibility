...
// - Records a real-time-factor (RTF) benchmark summary
//
// =============================================================================
...
std::string BuildOutputDirectory(const std::string& rheology_model_crm,
    ...
    std::stringstream ss;
    ss << std::fixed;
    ss << GetChronoOutputPath() << "ROBOT_Lander_CRM_RTFBenchmark";
...
int main(int argc, char* argv[]) {
    ...
    cli.AddOption<std::string>("Output", "body_output", "Save lander body state CSV output",
                               body_output ? "true" : "false");
