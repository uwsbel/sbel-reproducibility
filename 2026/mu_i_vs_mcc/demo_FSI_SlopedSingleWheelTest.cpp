...
// =============================================================================
// Sloped single wheel test. A Viper wheel is driven through CRM terrain
// (optionally on a slope, applied by tilting gravity) while drawbar pull,
// torque, and slip are recorded.
// =============================================================================
...
std::string BuildOutputDirectory(const SimParams& params) {
    std::string root = GetChronoOutputPath() + "FSI_SlopedSingleWheelTest";

    std::stringstream ss;
    ss << std::fixed;
    ss << root << "/ps_" << params.ps_freq;
