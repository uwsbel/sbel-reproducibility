...
```
If your machine has a newer system CUDA toolkit than the one bundled with PyTorch, install GroundingDINO in CPU mode by exporting `GROUNDINGDINO_FORCE_CPU=1` for that install step.
